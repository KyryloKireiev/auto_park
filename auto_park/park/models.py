...
class Driver(models.Model):
    ...
    first_name = models.CharField('Driver name:', max_length=50)
    last_name = models.CharField('Driver surname:', max_length=50)
...
class Vehicle(models.Model):
    ...
    plate_number = models.CharField('Number:', max_length=50)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
